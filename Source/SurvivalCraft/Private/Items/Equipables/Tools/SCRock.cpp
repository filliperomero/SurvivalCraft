...
#include "Items/Equipables/Tools/SCRock.h"
...
void ASCRock::UseItem_Implementation(ASCCharacter* SCCharacter, FRotator ClientCameraRotation)
{
	SCCharacter->PlayEquipableMontage(FName("Rock"));
}

void ASCRock::Interact_Implementation(const FVector& LocationToCheck, const FRotator& Rotation)
{
...
void ASCRock::HarvestFoliage(float Damage, AActor* Target)
{
...
int32 ASCRock::CalculateGivenQuantity(const FResourceInfo& Resource) const
{
...
void ASCRock::MulticastHitEffect_Implementation(const FVector_NetQuantize& Location, const FRotator& Rotation)
{
